...
class MomoCrawler(BaseCrawler):
    ...
    platform_badge_color: str = "#FF1493"  # Momo 粉紅色
    ...
    async def fetch_products(self, keyword: str, limit: int = 30) -> List[ProductItem]:
        ...
        async with httpx.AsyncClient(
            ...
            for item in raw_items[:limit]:
                ...
                image_url = item.get("imgUrl") or f"https://img4.momoshop.com.tw/goodsimg/{padded[:4]}/{padded[4:7]}/{padded[7:]}/{goods_code}_R.jpg"
